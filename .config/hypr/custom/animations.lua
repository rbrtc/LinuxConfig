...
hl.curve("expressiveDefaultSpatial", { type = "bezier", points = { { 0.38, 1.21 }, { 0.22, 1 } } })
...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4, bezier = "emphasizedDecel", style = "popin" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 7, bezier = "emphasizedDecel", style = "popin 90%" })
